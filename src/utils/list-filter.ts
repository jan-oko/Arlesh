 ...
 *
 * Only the pill dimensions a Commitment actually has are consulted: parent, antecedent, scope
 * state and verdict. A task-status or blocked pill is not "failed" by a commitment, it simply
