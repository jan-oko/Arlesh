...
Filterable fields: parent domain/task, dependency, status, delegate-to, delegated/undelegated, agentic, asynchronous, Person/Event/Thread/Scope, planned scope, Project, Aspect, Goal, Tag.
