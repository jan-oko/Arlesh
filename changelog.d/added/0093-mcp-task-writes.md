- **Agents can create and work their own Tasks over MCP.** Inside the parts of the board you have
  ...
  you marked Not agentic, and can retitle, brief, start, finish, move and archive Tasks that read as
  Agentic, including Habit occurrences, whose edits land on that one occurrence. A status change
