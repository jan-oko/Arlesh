...
- Instances must satisfy scope containment against the Target Node; the target picker offers only scope-valid targets, and editing the scope of an item that has flow children prompts reconciliation (Phase 7.5).
